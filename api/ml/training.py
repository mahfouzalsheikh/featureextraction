...
def run_final_eval(train_session, module_spec, class_count, image_lists,
                   ...
                   test_batch_size, bottleneck_dir, image_dir, tfhub_module,
                   print_misclassified_test_images, final_tensor_name,
                   learning_rate):
...
def save_graph_to_file(graph_file_name, module_spec,
        class_count, final_tensor_name, learning_rate):
...
def export_model(module_spec, class_count, saved_model_dir,
    ...
    with sess.graph.as_default() as graph:
        tf.saved_model.simple_save(
            ...
            outputs={'prediction': graph.get_tensor_by_name('results:0')},
